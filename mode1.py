...
# property_data = pd.read_csv('property-char.csv')  # Load property data



# Merge property data with CEJST
# CEJST = pd.merge(CEJST, property_data, how='left', on='property_id')  # Replace 'property_id' with the actual identifier for the property
